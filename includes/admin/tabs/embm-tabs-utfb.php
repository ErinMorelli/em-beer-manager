        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <p class="description">
                        <?php _e('A location must be selected to use this feature.', 'embm'); ?><br />
                        <?php _e('Associate existing beers with your Untappd for Business menus and update menu data.', 'embm'); ?><br />
                    </p>
                </td>
            </tr>
            <tr>
