...
$sections = array(
    array(
        ...
        'title'    => __('Single Beer Display', 'embm')
    ),
    array(
        'id'       => 'embm_list_all_beers',
        'title'    => __('List All Beers', 'embm')
    ),
    array(
        'id'       => 'embm_beer_menu_display',
        'title'    => __('Beer Menu Display', 'embm')
    )
);
...
<table class="embm-settings--table" cellpadding="0" cellspacing="0" border="0">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php _e('Comma-separated list of style names, slugs, or IDs', 'embm'); ?><br />e.g. <code>"india-pale-ale, pale-ale"</code></td>
            <td>n/a</td>
            <td><?php _e('Displays only beers belonging to specific beer styles', 'embm'); ?></td>
        </tr>
        <tr>
            <td><code><strong>group</strong></code></td>
            <td><?php _e('Comma-separated list of group names, slugs, or IDs', 'embm'); ?><br />e.g. <code>"Seasonal, Barrel-Aged"</code></td>
            <td>n/a</td>
            <td><?php _e('Displays only beers belonging to specific groups', 'embm'); ?></td>
        </tr>
        <tr>
...
<h2><?php _e('Beer Menu Display', 'embm'); ?></h2>

<p><?php _e('These will display a beer menu given it\'s Name, Slug, or ID number.', 'embm'); ?></p>
...
<table class="embm-settings--table" cellpadding="0" cellspacing="0" border="0">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><code>true, false</code></td>
            <td><code>true</code></td>
            <td><?php _e('Displays or hides the menu\'s last updated timestamp', 'embm'); ?></td>
        </tr>
        <tr>
            <td><code><strong>show_thumbnail</strong></code></td>
            <td><code>true, false</code></td>
            <td><code>true</code></td>
            <td><?php _e('Displays or hides the beer featured image thumbnails', 'embm'); ?></td>
        </tr>
        <tr>
            <td><code><strong>show_description</strong></code></td>
            <td><code>true, false</code></td>
            <td><code>true</code></td>
            <td><?php _e('Displays or hides the menu section descriptions', 'embm'); ?></td>
        </tr>
    </tbody>
</table>
