...
<div class="embm-metabox embm-metabox--profile">
    <div class="embm-metabox__field embm-metabox--profile-malts">
        <p>
            <label for="embm_malts"><strong><?php _e('Malts', EMBM_DOMAIN); ?></strong></label><br />
    ...
    <div class="embm-metabox__field embm-metabox--profile-hops">
        <p>
            <label for="embm_hops"><strong><?php _e('Hops', EMBM_DOMAIN); ?></strong></label><br />
    ...
    <div class="embm-metabox__field embm-metabox--profile-adds">
        <p>
            <label for="embm_adds"><strong><?php _e('Additions/Spices', EMBM_DOMAIN); ?></strong></label><br />
    ...
    <div class="embm-metabox__field embm-metabox--profile-yeast">
        <p>
            <label for="embm_yeast"><strong><?php _e('Yeast', EMBM_DOMAIN); ?></strong></label><br />
    ...
    <div class="embm-metabox__field embm-metabox--profile-abv">
        <p>
            <label for="embm_abv"><strong><?php _e('ABV', EMBM_DOMAIN); ?></strong></label><br />
    ...
    <div class="embm-metabox__field embm-metabox--profile-ibu">
        <p>
            <label for="embm_ibu"><strong><?php _e('IBU', EMBM_DOMAIN); ?></strong></label><br />
